...
//    }
    ...
    public void checkOrderAchievements(Student student, double orderTotal) {
        if (student.getPoints() < 100 && orderTotal > 0) {
            ...
            System.out.println("🌟 First order bonus! "+ "Your points now are "+student.getPoints()+" Keep ordering to earn more points! ");
            System.out.println();
        }
        ...
        if (orderTotal > 200) {
            ...
            System.out.println("🎉 Big order bonus! +20 points"+" Your points now are "+student.getPoints());
        }
    }
